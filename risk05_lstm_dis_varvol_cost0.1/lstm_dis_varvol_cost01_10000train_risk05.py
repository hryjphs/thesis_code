...
class Agent():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size, env,
        ...
        self.q_eval = DuelingDeepQNetwork(n_actions, fc0_dims, fc1_dims, fc2_dims, name='eval_dv01_risk05')
        self.q_next = DuelingDeepQNetwork(n_actions, fc0_dims, fc1_dims, fc2_dims, name='target_dv01_risk05')
