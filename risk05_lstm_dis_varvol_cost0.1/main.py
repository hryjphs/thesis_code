...
filename = 'dddqn_tf2_lstm_dv01_risk05.png'
...
delta_u,delta_r,delta_pl,delta_cpl = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='delta_dv01_risk05', delta_flag=True, bartlett_flag=False)
barlette_u,barlette_r,barlette_pl,barlette_cpl = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='barlette_dv01_risk05', delta_flag=False, bartlett_flag=True)

rl_u,rl_r,rl_pl,rl_cpl = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='rl_dv01_risk05', delta_flag=False, bartlett_flag=False)
...
df1.to_csv('delta_dv01_r_risk05.csv', index=False, encoding='utf-8')
...
df2.to_csv('rl_dv01_r_risk05.csv', index=False, encoding='utf-8')
...
df7.to_csv('barlette_dv01_r_risk05.csv', index=False, encoding='utf-8')        
...
df3.to_csv('rl_dv01_cpl_risk05.csv', index=False, encoding='utf-8')    

history = dict(zip(epi, delta_cpl))
#name = os.path.join('history', name)
df4 = pd.DataFrame(history,index=[0])
df4.to_csv('delta_dv01_cpl_risk05.csv', index=False, encoding='utf-8')    

history = dict(zip(epi, barlette_cpl))
#name = os.path.join('history', name)
df8 = pd.DataFrame(history,index=[0])
df8.to_csv('barlette_dv01_cpl_risk05.csv', index=False, encoding='utf-8')        
...
df9.to_csv('barlette_dv01_pl_risk05.csv', index=False, encoding='utf-8')  
...
df5.to_csv('rl_dv01_pl_risk05.csv', index=False, encoding='utf-8')        
...
df6.to_csv('delta_dv01_pl_risk05.csv', index=False, encoding='utf-8')    
