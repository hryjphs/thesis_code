...
class Agent():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size, env,
        ...
        self.q_eval = DuelingDeepQNetwork(n_actions, fc0_dims, fc1_dims, fc2_dims, name='eval_dv05_risk05')
        self.q_next = DuelingDeepQNetwork(n_actions, fc0_dims, fc1_dims, fc2_dims, name='target_dv05_risk05')
...
if __name__ == '__main__':
    ...
    filename = 'dddqn_tf2_lstm_dv05.png'
    ...
    delta_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='delta_dv05', delta_flag=True, bartlett_flag=False)
    barlette_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='barlette_dv05', delta_flag=False, bartlett_flag=True)

    rl_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='rl_dv05', delta_flag=False, bartlett_flag=False)
    
    plot_obj(delta_u, figure_file='delta_u_dv05')
    plot_obj(rl_u, figure_file='rl_u_dv05')
    plot_obj(barlette_u, figure_file='barlette_u_dv05')
