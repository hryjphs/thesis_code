...
class Agent():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size, env,
        ...
        self.q_eval = DuelingDeepQNetwork(n_actions, fc0_dims, fc1_dims, fc2_dims, name='eval_dv0_risk05')
        self.q_next = DuelingDeepQNetwork(n_actions, fc0_dims, fc1_dims, fc2_dims, name='target_dv0_risk05')
...
if __name__ == '__main__':
    ...
    filename = 'dddqn_tf2_lstm_dv0.png'
    ...
    delta_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='delta_dv0', delta_flag=True, bartlett_flag=False)
    barlette_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='barlette_dv0', delta_flag=False, bartlett_flag=True)

    rl_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='rl_dv0', delta_flag=False, bartlett_flag=False)
