...
filename = 'dddqn_tf2_lstm_dc1.png'
...
delta_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='delta__dc1', delta_flag=True, bartlett_flag=False)
rl_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='rl_dc1', delta_flag=False, bartlett_flag=False)
    
plot_obj(delta_u, figure_file='delta_u_dc1')
plot_obj(rl_u, figure_file='rl_u_dc1')