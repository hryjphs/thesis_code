...
filename = 'dddqn_tf2_lstm_dc2.png'
...
delta_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='delta__dc2', delta_flag=True, bartlett_flag=False)
rl_u = test(total_episode_test = total_episode_test, env = env_test2, agent = agent, name='rl_dc2', delta_flag=False, bartlett_flag=False)
    
plot_obj(delta_u, figure_file='delta_u_dc2')
plot_obj(rl_u, figure_file='rl_u_dc2')